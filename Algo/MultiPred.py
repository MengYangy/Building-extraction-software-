...
def img_pred(imgpath, modelpath, savepath, img_h_w):
    ...
    for im in range(len(images)):
        name = os.listdir(imgpath)[im].split('.')[0]
        ...
        cv.imwrite(savepath + '{}_pred.png'.format(name), mask_whole)
        print('完成第{}张图像预测'.format(im + 1))
        sys.stdout.flush()


if __name__ == '__main__':
    # img_pred(imgpath='D:\\demo\\dome_data\\test\\',
    #          modelpath='E:\\data\\model\\aerial\\wedata_unet_v1.h5',
